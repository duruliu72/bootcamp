        ...
        <div className="bootcamps-section mt-5">
             <div className="container">
                ...
                <div className="col-md-8">
                    ...
                    <Pagination itemCounts={props.itemCount} pageSize={props.pageSize} currentPage={props.currentPage} onPageChange={props.handlePageChange} />
                </div>
                </div>
            </div>
        </div>
